...
import os,sys
filepath='/share/spandh.ami1/dia/mtg.ihm/exp/acftrain1sad1.ihm/dnn/base.sns/rt07/mlabs/rt07.mlf/rt07.auto1.ihm.sns.complete.mlf.CMU-0E07000-CM00x-R7'
oldfile = filepath
newfile = filepath+'.temp'
f = open(oldfile,'r')
while True:
    line = f.readline()
    if 'SPEECH' in line:

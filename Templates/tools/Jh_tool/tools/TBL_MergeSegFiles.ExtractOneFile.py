...
mlf2 = open('/share/spandh.ami1/usr/yanxiong/data/tbl.full.fbank.new/onefile.mlf','wa')
mlf2.write(line1) # write the first line
numofletter = 16 # 16 for TBL dataset, 24 for WKA dataset. the first 16 letter of file name
...
while True:
    ...
    if not line1:
        break
    if 'TBL1702-MIXA1' in line1 and 'lab' in line1:

...
# another MLF file
import os,sys
scp1 = open('/share/spandh.ami1/dia/mtg.ihm/exp/acftrain1sad1.ihm/dnn/base.sns/train.fbank.scp','r')
mlf2 = open('/share/spandh.ami1/dia/mtg.ihm/exp/acftrain1sad1.ihm/dnn/base.sns/train.mlf','wa')
